namespace GestionZapatillas.Windows
{
    partial class frmSportShoes
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgvDatos.Columns.AddRange(new DataGridViewColumn[] { colId, colModelo, colMarca, colDeporte, colPrecio, colActivo });
